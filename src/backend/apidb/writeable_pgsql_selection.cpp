...
int writeable_pgsql_selection::select_nodes_from_bbox(const bbox &bounds,
  ...
  return w.prepared(include_invisible ? "node_in_bbox" : "visible_node_in_bbox")(tiles)(int(bounds.minlat * SCALE))(
...
void writeable_pgsql_selection::select_ways_from_nodes(bool include_invisible) {
...
void writeable_pgsql_selection::select_nodes_from_way_nodes(bool include_invisible) {
